		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comcoopersapproject1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comcoopersapproject1-display": {
								"semanticObject": "comcoopersapproject1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.coopersap.project1",
									"url": sap.ui.require.toUrl("com/coopersap/project1")
								}
							}
						}
					}
